...
final String Url = "meditationenthusiasts.org";
        ...
        stage( 'In Docker' )
        {
            ...
            stages
            {
                stage( 'prepare' )
                {
                    steps
                    {
                        sh "dotnet tool update Cake.Tool --version ${CakeVersion} --tool-path ./Cake";
            ...
            steps
            {
                ...
                )
                {
                    script
                    {
                        ...
                        sh "cd ./checkout/_site && rsync --rsh=\"ssh ${verbose} ${sshOptions}\" -az --delete --exclude \".well-known\" ./ ${SSHUSER}@${Url}:${Url}";
                    }
                }
            }
        }
